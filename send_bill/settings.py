"""
Django settings for SendBill project.
...
SECRET_KEY = 'SePXjIKioxznfJEDkohTFYfisUyVsPkNIzSKiKuj'
...
WSGI_APPLICATION = 'send_bill.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DJANGO_DATABASE_NAME', 'send_bill'),
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'send_bill_language'
LANGUAGES = [
...
LOGGING = {
    ...
    'loggers': {
        ...
        'send_bill': {
            'handlers': ['console'],
            'level': os.environ.get('SEND_BILL_LOG_LEVEL', 'INFO'),
        }
    }
}
